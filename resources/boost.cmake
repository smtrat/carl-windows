...
set(BOOST_OPTIONS --without-atomic --without-chrono --without-context --without-coroutine --without-coroutine2 --without-fiber --without-iostreams --without-locale --without-mpi --without-python --without-random --without-regex --without-serialization --without-signals --without-thread --without-timer --without-wave)
...
ExternalProject_Add(
	...
	INSTALL_COMMAND ${Boost_b2_Command} -s NO_BZIP2=1 --variant=release ${BOOST_OPTIONS} install --prefix=<INSTALL_DIR>
)
...
add_dependencies(Boost_SHARED Boost-EP GMPXX_SHARED)
add_dependencies(Boost_STATIC Boost-EP GMPXX_STATIC)
